# -*- coding: utf-8 -*-
"""Data Cleaning in Python  (1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1js7dM83LN5tpLO6yjfY9GnpdQuzLmVxh
...
# if wanna replace 15 ps --->20 ps

df1.iloc[3,0]=18

df3= pd.DataFrame({"Age":[40,41,43,40,20],
                   "Name":["Ks","vk","vs","ps","os"]})
df3

#instead of assigning a varibale or writing varibale name always we vando inplace = true so chnages automatically save in the original object
##if wanna replcae all 40 t0 21
df3["Age"].replace({40:21}, inplace = True)
df3
